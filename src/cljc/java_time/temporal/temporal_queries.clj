(ns cljc.java-time.temporal.temporal-queries (:import [java.time.temporal TemporalQueries]) (:refer-clojure :exclude [get range format min max next name resolve short]))
