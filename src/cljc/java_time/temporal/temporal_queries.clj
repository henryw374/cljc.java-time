(ns cljc.java-time.temporal.temporal-queries (:refer-clojure :exclude [get range format min max next name resolve]) (:import [java.time.temporal TemporalQueries]))
