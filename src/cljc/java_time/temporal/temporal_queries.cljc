(ns cljc.java-time.temporal.temporal-queries (:require [cljs.java-time.interop :as jti] #? (:cljs [java.time.temporal :refer [TemporalQueries]])) (:refer-clojure :exclude [get range format min max next name resolve]) #? (:clj (:import [java.time.temporal TemporalQueries])))
